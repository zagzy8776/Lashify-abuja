...
export const SERVICE_CATALOG: ServiceCatalogItem[] = [
  ...
  { name: 'Wispy hybrid set', slug: 'wispy-hybrid-set', category: 'lash', price: 30000, duration_minutes: 120, duration_text: '2hr', description: 'A highly textured, fluttery look featuring varying lengths and "spikes" to create a modern, effortlessly chic style.', sort_order: 16 },
