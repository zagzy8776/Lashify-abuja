...
export default function Booking({ preselectedService }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Open WhatsApp so customer can send payment receipt immediately
      ...
      <section className="pt-32 pb-24 min-h-screen section-light flex items-center">
        <div className="container-lux max-w-2xl">
          <div className="card-lux p-10 md:p-14 text-center animate-scale-in shadow-2xl border border-rose-100">
            ...
            <h2 className="heading-serif text-4xl mb-4 text-gray-900">Appointment Requested!</h2>
            <p className="leading-relaxed mb-8 text-rose-500">
              ...
              Send your payment receipt on WhatsApp and I will confirm your appointment shortly.
            </p>
            ...
            <a
              href={`https://wa.me/${PAYMENT_ACCOUNT.whatsapp}?text=${encodeURIComponent('Hi, I just booked ' + confirmedAppointment.service_name + ' and paid. Here is my receipt.')}`}
              target="_blank"
          ...
          <div className="bg-white rounded-[32px] shadow-xl border border-gray-100 p-8 md:p-10 animate-fade-up">
            ...
            <div className="rounded-xl p-5 mb-6 text-center space-y-3" style={{ background: '#fdfbf9', border: '1px dashed #b38b9e' }}>
              ...
              <div className="bg-white rounded-lg p-4 inline-block text-left shadow-sm">
                ...
                <p className="font-bold text-lg mb-3 text-gray-900">{PAYMENT_ACCOUNT.bankName}</p>
                <p className="text-xs uppercase tracking-wider mb-1 text-gray-700">Account Number</p>
                <p className="font-bold text-2xl tracking-widest mb-3 text-rose-500">{PAYMENT_ACCOUNT.accountNumber}</p>
                <p className="text-xs uppercase tracking-wider mb-1 text-gray-700">Account Name</p>
                <p className="font-bold text-lg text-gray-900">{PAYMENT_ACCOUNT.accountName}</p>
              </div>
              <p className="text-xs text-rose-500">After transfer, tap the button below — WhatsApp will open so you can send your receipt.</p>
            </div>
            ...
            <button onClick={handleSubmit} disabled={submitting}
              ...
              {submitting ? (<><Loader2 className="w-5 h-5 animate-spin" /> Submitting Booking...</>) : (<><Check className="w-5 h-5" /> I Have Paid — Open WhatsApp</>)}
            </button>
          </div>
        )}
      </div>
