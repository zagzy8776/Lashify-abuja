        ...
        {step === 'confirm' && selectedService && selectedDate && selectedTime && (
          <div className="bg-white rounded-[32px] shadow-xl border border-gray-100 p-8 md:p-10 animate-fade-up">
            ...
            <div className="rounded-xl p-5 mb-6 text-center space-y-3" style={{ background: '#fdfbf9', border: '1px dashed #b38b9e' }}>
              ...
              <p className="text-xs text-rose-500">After transfer, send your receipt on WhatsApp so I can confirm your booking.</p>
              <a href={`https://wa.me/${PAYMENT_ACCOUNT.whatsapp}?text=${encodeURIComponent('Hi, I just booked and paid. Here is my receipt.')}`}
                target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 mt-2 px-5 py-3 rounded-full bg-[#25D366] text-white text-sm font-bold">
                Send receipt on WhatsApp
              </a>
            </div>
            ...
            <button onClick={handleSubmit} disabled={submitting}
              ...
              {submitting ? (<><Loader2 className="w-5 h-5 animate-spin" /> Submitting Booking...</>) : (<><Check className="w-5 h-5" /> I Have Made The Transfer</>)}
            </button>
          </div>
        )}
      </div>
